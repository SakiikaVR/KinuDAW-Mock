...
**v0.2.0は実処理を備えた開発版です。** 基本的な制作機能を動作確認していますが、市販DAWと同等の機能・全プラグインの全プリセットでの互換性を保証するものではありません。未対応機能と検証範囲を下記に記載しています。

## 起動

1. [Windows x64開発版](https://github.com/SakiikaVR/KinuDAW-Mock/releases/tag/v0.2.0)のZIPを全体展開します。
